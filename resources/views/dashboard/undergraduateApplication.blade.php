        ...
        <div class="flex flex-wrap mb-4">
            <div class="w-full md:w-1/2 md:pr-4 relative">
                ...
                <select id="first_choice_program" name="first_choice_program" class="form-select rounded-md w-full">
                    <option value="bcp">Bachelor of Counselling Psychology (BCP)</option>
                    <option value="bis">Bachelor of Information Systems (BIS)</option>
                    <option value="bcom">Bachelor of Commerce (BCOM)</option>
                    <option value="bsm">Bachelor of Agri-Systems Management (BSM)</option>
                    <option value="bait">Bachelor of Applied Information Technology (BAIT)</option>
                </select>
                <span class="text-red-500 absolute top--px right--2">*</span>
            </div>
